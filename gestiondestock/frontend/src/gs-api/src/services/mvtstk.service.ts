...
class MvtstkService extends __BaseService {
  static readonly correctionStockNegPath = '/gestiondestock/v1/correctionneg';
  static readonly correctionStockPosPath = '/gestiondestock/v1/correctionpos';
  static readonly entreeStockPath = '/gestiondestock/v1/entree';
  ...
  static readonly sortieStockPath = '/gestiondestock/v1/sortie';
  ...
  correctionStockNegResponse(body?: MvtStkDto): __Observable<__StrictHttpResponse<MvtStkDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondestock/v1/correctionneg`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  correctionStockPosResponse(body?: MvtStkDto): __Observable<__StrictHttpResponse<MvtStkDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondestock/v1/correctionpos`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  entreeStockResponse(body?: MvtStkDto): __Observable<__StrictHttpResponse<MvtStkDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondestock/v1/entree`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  sortieStockResponse(body?: MvtStkDto): __Observable<__StrictHttpResponse<MvtStkDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondestock/v1/sortie`,
      __body,
      {
        headers: __headers,
        params: __params,
